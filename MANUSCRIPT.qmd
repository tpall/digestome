...
| | module-level reconstruction | independent of KEGG | no restricted dependency anywhere | AD pathway model |
|---|---|---|---|---|
| DRAM [@shaffer2020dram] | ✓ | optional | ✗ (dbCAN, MEROPS) | ✗ |
| METABOLIC [@zhou2022metabolic] | ✓ | ✗ (KOfam) | ✗ | ✗ |
| nf-core/mag [@krakau2022mag] | ✗ | ✗ | ✗ | ✗ |
| nf-core/metatdenovo [@metatdenovo2025] | ✗ | ✗ (eggNOG, KofamScan) | ✗ | ✗ |
| this work | ✓ | ✓ | ✓ | ✓ |

METABOLIC reconstructs at module level but resolves everything through KEGG KOfam. The
metagenomic Nextflow pipelines stop earlier: nf-core/mag ends at binning and taxonomic
classification, and nf-core/metatdenovo produces per-gene annotated catalogues without binning
at all, explicitly directing users elsewhere for MAGs. Both route functional annotation through
KEGG or eggNOG, and going via eggNOG-mapper does not evade the constraint, since the KEGG
orthology identifiers it emits are themselves KEGG content.
